...
impl TryFrom<&super::ObjectReference> for sui_sdk_types::types::ObjectReference {
    ...
    fn try_from(value: &super::ObjectReference) -> Result<Self, Self::Error> {
        ...
        Ok(Self::new(object_id, value.version, digest))
    }
}
...
impl TryFrom<&super::Object> for sui_sdk_types::types::Object {
    ...
    fn try_from(value: &super::Object) -> Result<Self, Self::Error> {
        ...
        let previous_transaction = value
            ...
            .pipe(TryInto::try_into)?;
        let storage_rebate = value.storage_rebate;
...
impl From<sui_sdk_types::types::MoveStruct> for super::MoveStruct {
    fn from(value: sui_sdk_types::types::MoveStruct) -> Self {
        Self {
            ...
            has_public_transfer: value.has_public_transfer(),
            version: value.version(),
...
impl TryFrom<&super::MoveStruct> for sui_sdk_types::types::MoveStruct {
    ...
    fn try_from(value: &super::MoveStruct) -> Result<Self, Self::Error> {
        ...
        let has_public_transfer = value.has_public_transfer;
        let version = value.version;
        let contents = value.contents.to_vec();
    ...
    fn from(value: sui_sdk_types::types::MovePackage) -> Self {
        ...
        let linkage_table = value
            ...
            .map(
                |(
                    original_id,
                    sui_sdk_types::types::UpgradeInfo {
                        upgraded_id,
                        upgraded_version,
                    },
                )| {
        ...
        let modules = value
            ...
            .map(|module| {
                let name = module
                    ...
                    .pipe(TryInto::try_into)?;
                let contents = module.contents.to_vec();
        ...
        let linkage_table = value
            ...
            .map(|upgrade_info| {
                ...
                let upgraded_id = upgrade_info
                    ...
                    .pipe(TryInto::try_into)?;
                let upgraded_version = upgrade_info.upgraded_version;
