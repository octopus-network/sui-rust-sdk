...
pub struct CheckpointSummary {
    ...
    pub version_specific_data: ::prost::bytes::Bytes,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct CheckpointContents {
    #[prost(oneof = "checkpoint_contents::Contents", tags = "3")]
...
pub struct Transaction {
    #[prost(oneof = "transaction::Version", tags = "3")]
...
pub struct RandomnessStateUpdate {
    ...
    pub random_bytes: ::prost::bytes::Bytes,
    #[prost(uint64, tag = "4")]
    pub randomness_object_initial_shared_version: u64,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct JwkId {
    #[prost(bytes = "bytes", tag = "1")]
    pub iss: ::prost::bytes::Bytes,
    #[prost(bytes = "bytes", tag = "2")]
    pub kid: ::prost::bytes::Bytes,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Jwk {
    /// Key type parameter, <<https://datatracker.ietf.org/doc/html/rfc7517#section-4.1>>
    #[prost(bytes = "bytes", tag = "1")]
    pub kty: ::prost::bytes::Bytes,
    /// RSA public exponent, <<https://datatracker.ietf.org/doc/html/rfc7517#section-9.3>>
    #[prost(bytes = "bytes", tag = "2")]
    pub e: ::prost::bytes::Bytes,
    /// RSA modulus, <<https://datatracker.ietf.org/doc/html/rfc7517#section-9.3>>
    #[prost(bytes = "bytes", tag = "3")]
    pub n: ::prost::bytes::Bytes,
    /// Algorithm parameter, <<https://datatracker.ietf.org/doc/html/rfc7517#section-4.4>>
    #[prost(bytes = "bytes", tag = "4")]
    pub alg: ::prost::bytes::Bytes,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct TransactionEffects {
    #[prost(oneof = "transaction_effects::Version", tags = "3, 4")]
...
pub struct ChangedObject {
    #[prost(message, optional, tag = "1")]
    pub object_id: ::core::option::Option<ObjectId>,
    #[prost(enumeration = "IdOperation", tag = "7")]
    pub id_operation: i32,
...
pub struct UserSignature {
    #[prost(oneof = "user_signature::Signature", tags = "2, 3, 4")]
...
pub struct ZkLoginInputs {
    ...
    #[prost(bytes = "bytes", tag = "3")]
    pub header_base64: ::prost::bytes::Bytes,
    #[prost(message, optional, tag = "4")]
    pub address_seed: ::core::option::Option<Bn254FieldElement>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
